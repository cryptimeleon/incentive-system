...
public class BasketserverClientTests {
  ...
  void basketItemsTest(@Autowired WebTestClient webTestClient) {
    ...
    assertThat(basket.getValue())
        .isEqualTo(3 * firstTestItem.getPrice() + secondTestItem.getPrice());
  ...
  void redeemTest(@Autowired WebTestClient webTestClient) {
    ...
    redeemBasket(
        webTestClient, basketId, "Some Request", basket.getValue(), HttpStatus.BAD_REQUEST);
    ...
    redeemBasket(
        webTestClient, basketId, "Some Request", basket.getValue() + 1, HttpStatus.BAD_REQUEST);
    ...
    redeemBasket(
        webTestClient, basketId, "Another Request", basket.getValue(), HttpStatus.BAD_REQUEST);
