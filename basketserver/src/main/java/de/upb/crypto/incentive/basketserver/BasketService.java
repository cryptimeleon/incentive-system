...
/**
 * Service containing the business logic of the basket server. Currently simulating the behavior of
 * a database with in-memory objects
 */
@Service
public class BasketService {
  ...
  BasketService() {
    ...
    items =
        new ArrayList<>(
            Arrays.asList(
                new Item(UUID.fromString("b363b7fa-14b9-402b-98b2-6e7370d62595"), "Tomato", 30),
                new Item(UUID.fromString("1f360b5f-f458-4f42-af93-50fbe8a68846"), "Apple", 50),
                new Item(UUID.fromString("a785cdb7-eac4-4b28-908b-2ba18944a79e"), "Peach", 30),
  ...
  public void redeemBasket(UUID basketId, String redeemRequest, long value)
  ...
  /*
   * Function for computing the value of a basket. Basket does not know its value
   * to prevent redundant data / weird data ownership.
   */
