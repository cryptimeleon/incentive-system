...
public class DsprotectionService {
     ...
     */
    @Autowired
    private DsprotectionService(CryptoRepository cr, TransactionEntryRepository taEntryRepo, DsidRepository dsidRepo, DsTagEntryRepository dsTagEntryRepo, UserInfoRepository uInfoRepo) {
    ...
    public void dbSync(String serializedTidRepr, String serializedDsidRepr, String serializedDsTagRepr, BigInteger promotionId, String userChoice) {
        ...
        theIncSys.dbSync(tid, dsid, dsTag, userChoice, promotionId, this.localDbHandler);
    }
    ...
    public String getTransaction(String serializedTaIdentifierRepr) {
        ...
        JSONConverter jsonConverter = new JSONConverter();
        TransactionIdentifier taIdentifier = new TransactionIdentifier(jsonConverter.deserialize(serializedTaIdentifierRepr), cryptoRepository.getPp());
