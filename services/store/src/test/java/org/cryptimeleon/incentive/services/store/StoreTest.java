...
import org.cryptimeleon.incentive.services.store.repository.CryptoRepository;
import org.cryptimeleon.incentive.services.store.repository.DsidBlacklistRepository;
import org.cryptimeleon.incentive.services.store.repository.PromotionRepository;
...
public class StoreTest {
    ...
    void earnPointsTest(@Autowired WebTestClient webTestClient) {
        ...
        Vector<BigInteger> deltaK = TestSuiteWithPromotion.promotion.computeEarningsForBasket(IncentiveService.promotionBasketFromBasketEntity(basket));
