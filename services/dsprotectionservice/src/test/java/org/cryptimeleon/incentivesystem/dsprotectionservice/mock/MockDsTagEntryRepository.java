...
public class MockDsTagEntryRepository implements DsTagEntryRepository {
    ...
    public MockDsTagEntryRepository() {
        doubleSpendingTagEntries = new HashMap<Long, DsTagEntry>();
        nextId = 0;
    }
    ...
    public ArrayList<DsTagEntry> findAll() {
        ArrayList<DsTagEntry> results = new ArrayList<DsTagEntry>();
    ...
    public ArrayList<DsTagEntry> findAllById(Iterable<Long> ids) {
        ...
        for(long id:ids) {
            DsTagEntry dste = findById(id).get();
            if(dste!=null) {
                results.add(dste);
            }
        }
    ...
    public void deleteAll() {
        this.doubleSpendingTagEntries = new HashMap<Long, DsTagEntry>();
    }
}
